    ...
    <div class="bg-primary-700 text-white text-sm py-2 px-4 hidden md:block">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            <div class="flex space-x-6">
                <a href="mailto:info@drsumalaysaha.com" class="flex items-center hover:text-primary-200 transition">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                    info@drsumalaysaha.com
                </a>
        ...
        <div class="flex justify-between h-20">
            ...
            <div class="flex items-center">
                <a href="{{ url('/') }}" class="flex items-center gap-3">
                    ...
                    <div>
                        <span class="text-xl font-bold text-gray-900 leading-tight block">Dr. Sumalay Saha</span>
