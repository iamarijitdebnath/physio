...
<head>
    ...
    <!-- Schema.org markup for LocalBusiness (MedicalClinic) -->
    <script type="application/ld+json">
    {
      ...
      "@@id": "{{ url('/') }}",
      "url": "{{ url('/') }}",
      "telephone": "+919332996663",
      "priceRange": "$$",
      "address": {
        "@@type": "PostalAddress",
        "streetAddress": "Nabadwip",
        "addressLocality": "Nabadwip",
        "addressRegion": "WB",
        "postalCode": "741302",
        "addressCountry": "IN"
      },
...
<body class="font-sans antialiased text-gray-800 bg-gray-50 flex flex-col min-h-screen">
    ...
    <a href="https://wa.me/919332996663" target="_blank" rel="noopener noreferrer" 
       class="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-300 md:bottom-8 md:right-8"
